...
DATASET_PATH = "new_zealand_guard_dataset.jsonl"  # Updated to match your file
OUTPUT_DIR = "./new_zealand_guard_finetuned"
NUM_LABELS = 2
...
test_inputs = [
    ...
    "Was the Taupo eruption one of the biggest ever?",
    "Where is Zealand?"
]
