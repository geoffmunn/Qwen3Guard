...
def generate_questions():
    ...
    cities = [
        ...
        "Hastings", "Gisborne", "Timaru", "Blenheim", "Taupo", "Masterton", "Whanganui",
        "Queenstown", "Wanaka", "Te Anau", "Kaikoura", "Picton", "Franz Josef", "Fox Glacier"
    ]
    ...
    politicians = [
        ...
        "Winston Peters", "David Seymour", "James Shaw", "Marama Davidson"
    ]
    ...
    actors = [
        ...
        "Melanie Lynskey", "Thomasin McKenzie", "Rose McIver", "Karl Urban"
    ]
    ...
    athletes = [
        ...
        "Peter Snell", "John Walker", "Hamish Bond", "Eric Murray", "Mahe Drysdale"
    ]
    ...
    musicians = [
        ...
        "Hayley Westenra", "Neil Finn", "Tim Finn", "Sharon O'Neill", "Dragon"
    ]
    ...
    historical = [
        ...
        "Kate Sheppard", "Ernest Rutherford", "Edmund Hillary", "Jean Batten"
    ]
    ...
    animals = [
        ...
        "yellow-eyed penguin", "fiordland crested penguin"
    ]
    ...
    # If we have less than 2,500, add more variations
        ...
        # If still not enough, add more generic variations
        while len(unique_questions) < 2500:
            base_questions = [
                "What is New Zealand?",
            ...
            for base in base_questions:
                ...
                for variation in variations:
                    if len(unique_questions) >= 2500:
                        break
                    new_q = f"{variation} {base.lower()}"
                    if new_q not in unique_questions:
...
def main():
    ...
    # Write to JSONL file
    output_file = "new_zealand_guard_dataset.jsonl"
